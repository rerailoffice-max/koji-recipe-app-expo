...
- [x] プロフィール画面（未ログイン時）のロゴをlogin-logo.pngに変更

### メニュー生成AI改善（2026/01/14）
- [x] 食材バリエーション大幅増加（各カテゴリ15-20パターン）
- [x] 季節の旬食材対応（春夏秋冬で自動切替）
- [x] 麹タイプと調理法の相性厳守（変な組み合わせ禁止）
  - 旨塩風こうじ → 和え、ナムル、おひたし、焼き、みそ汁、鍋
  - 中華風こうじ → 炒め、あんかけ、ナムル、鍋、スープ
  - コンソメ風こうじ → ソテー、スープ、ポトフ、シチュー、サラダ、マリネ
